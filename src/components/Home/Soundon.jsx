...
const UserProfile = () => {
  ...
  useEffect (() => {
    ...
    return (
      <div className='flex flex-col bg-zinc-900 h-screen w-full bg-gradient-to-t from-gray-700 via-gray-900 to-black'>
        {
          profile.display_name && profile.images && profile.followers.total && profile.uri && 
            <header 
              className='flex flex-cols-2 w-full h-72 text-base gap-10 items-center object-top
